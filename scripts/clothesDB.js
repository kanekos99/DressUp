const clothes = {
  hair: [
    ...
    },
    {
      ...
      name: "Braided Hair",
      category: "HAIR",
      imgHtml: `<img src="assets/hair/braid-cut.png" class="layer15 doll-layer" id="braided-hair"/>`,
      iconHtml: `<img src="assets/hair/icons/braid-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="braided-hair" data-category="hair">`,
      layer: 15,
      related: [],
      dependent: [],
    },
  ...
  inner: [
    ...
    },
    {
      ...
      name: "Cheongsam",
      category: "INNER",
      imgHtml: `<img src="assets/inner/cheongsam-a.png" class="layer5 doll-layer" id="cheongsam"/>`,
      iconHtml: `<img src="assets/inner/icons/cheongsam-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="cheongsam" data-category="inner">`,
      layer: 5,
      related: [],
      dependent: [],
      linkedItems: [
        {
          id: "cheongsam-b",
          imgHtml: `<img src="assets/inner/cheongsam-b.png" class="layer-1 doll-layer" id="cheongsam-b"/>`,
        },
      ],
    },
    {
      ...
      name: "Festive Robe",
      category: "INNER",
      imgHtml: `<img src="assets/inner/festive-robe-a.png" class="layer5 doll-layer" id="festive-robe"/>`,
      iconHtml: `<img src="assets/inner/icons/festive-robe-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="festive-robe" data-category="inner">`,
      layer: 5,
      related: [],
      dependent: [],
      linkedItems: [
        {
          id: "festive-robe-b",
          imgHtml: `<img src="assets/inner/festive-robe-b.png" class="layer-1 doll-layer" id="festive-robe-b"/>`,
        },
      ],
    },
  ],
  ...
  pants: [
    ...
    },
    {
      ...
      name: "Martial Pants",
      category: "PANTS",
      imgHtml: `<img src="assets/pants/martial-pants.png" class="layer2 doll-layer" id="martial-pants"/>`,
      iconHtml: `<img src="assets/pants/icons/martial-pants-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="martial-pants" data-category="pants">`,
      layer: 2,
      related: [],
      dependent: [],
    },
    ...
    },
    {
      ...
      category: "PANTS",
      imgHtml: `<img src="assets/pants/stockings.png" class="layer2 doll-layer" id="black-stockings"/>`,
      iconHtml: `<img src="assets/pants/icons/stockings-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="black-stockings" data-category="pants">`,
      layer: 2,
      related: [],
      dependent: [],
    },
  ...
  shoes: [
    ...
    },
    {
      ...
      name: "Martial Shoes",
      category: "SHOES",
      imgHtml: `<img src="assets/shoes/martial-shoes.png" class="layer3 doll-layer" id="martial-shoes"/>`,
      iconHtml: `<img src="assets/shoes/icons/martial-shoes-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="martial-shoes" data-category="shoes">`,
      layer: 3,
      related: [],
      dependent: [],
    },
    ...
    },
    {
      ...
      name: "Leg Ribbon",
      category: "SHOES",
      imgHtml: `<img src="assets/shoes/leg_ribbon.png" class="layer1 doll-layer" id="leg-ribbon"/>`,
    ...
    },
    {
      ...
      name: "Red Heels",
      category: "SHOES",
      imgHtml: `<img src="assets/shoes/red-heels.png" class="layer3 doll-layer" id="red-heels"/>`,
      iconHtml: `<img src="assets/shoes/icons/red-heels-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="red-heels" data-category="shoes">`,
      layer: 3,
      related: [],
      dependent: [],
    },
  ...
  accessories: {
    ...
    capes: [
      ...
      },
      {
        ...
        category: "ACCESSORIES",
        subcategory: "CAPES",
        imgHtml: `<img src="assets/cape/chrys-ribbon.png" height="700" class="layer13 doll-layer" id="chrys-ribbon"/>`,
      ...
      },
      {
        ...
        category: "ACCESSORIES",
        subcategory: "CAPES",
        imgHtml: `<img src="assets/cape/evening-cape-a.png" class="layer12 doll-layer" id="evening-cape"/>`,
        iconHtml: `<img src="assets/cape/icons/evening-cape-icon.png" class="item-btn" onclick="toggleItem(this);" data-item="evening-cape" data-category="accessories" data-subcategory="capes">`,
        layer: 12,
        related: [],
        dependent: [],
        linkedItems: [
          {
            id: "evening-cape-b",
            imgHtml: `<img src="assets/cape/evening-cape-b.png" class="layer-4 doll-layer" id="evening-cape-b"/>`,
          },
        ],
      },
    ],
...
const outfits = {
  ...
  dancerOutfit: {
    ...
    <img src="assets/cape/chrys-ribbon.png" height="700" class="layer13 doll-layer" id="chrys-ribbon">
    ...
    <img src="assets/shoes/leg_ribbon.png" class="layer1 doll-layer" id="leg-ribbon">
  ...
  cheongsamOutfit: {
    ...
    <img src="assets/under/white-under.png" class="layer1 doll-layer" id="white-under">
    <img src="assets/hair/short-ponytail.png" class="layer-2 doll-layer" id="short-ponytail">
    <img src="assets/inner/cheongsam-a.png" class="layer5 doll-layer" id="cheongsam">
    <img src="assets/inner/cheongsam-b.png" class="layer-1 doll-layer" id="cheongsam-b">
    <img src="assets/neck/neck-tassel.png" class="layer10 doll-layer" id="neck-tassel">
    <img src="assets/pants/stockings.png" class="layer2 doll-layer" id="black-stockings">
    <img src="assets/shoes/red-heels.png" class="layer3 doll-layer" id="red-heels">
    <img src="assets/head/flower-clip.png" class="layer9 doll-layer" id="flower-clip">
    <img src="assets/cape/evening-cape-a.png" class="layer12 doll-layer" id="evening-cape">
    <img src="assets/cape/evening-cape-b.png" class="layer-4 doll-layer" id="evening-cape-b">`,
    outfitObj: {
      hair: "short-ponytail",
      under: "white-under",
      outer: "",
      inner: "cheongsam",
      pants: "black-stockings",
      shoes: "red-heels",
      accessories: ["evening-cape", "flower-clip", "neck-tassel"],
    },
  },
  festiveOutfit: {
    outfitHTML: `<img src="assets/base.png" class="layer0 doll-layer" id="base-doll">
    ...
    <img src="assets/under/white-under.png" class="layer1 doll-layer" id="white-under">
    <img src="assets/neck/neck-tassel.png" class="layer10 doll-layer" id="neck-tassel">
    <img src="assets/inner/festive-robe-a.png" class="layer5 doll-layer" id="festive-robe">
    <img src="assets/inner/festive-robe-b.png" class="layer-1 doll-layer" id="festive-robe-b">
    <img src="assets/cape/evening-cape-a.png" class="layer12 doll-layer" id="evening-cape">
    <img src="assets/cape/evening-cape-b.png" class="layer-4 doll-layer" id="evening-cape-b">
    <img src="assets/pants/martial-pants.png" class="layer2 doll-layer" id="martial-pants">
    <img src="assets/shoes/martial-shoes.png" class="layer3 doll-layer" id="martial-shoes">
    <img src="assets/hair/braid-cut.png" class="layer15 doll-layer" id="braided-hair">`,
    outfitObj: {
      hair: "braided-hair",
      under: "white-under",
      outer: "",
      ...
      pants: "martial-pants",
      shoes: "martial-shoes",
      accessories: ["evening-cape", "neck-tassel"],
    },
  },
};
